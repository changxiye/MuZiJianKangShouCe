			...
			<view class="top_box">
				...
				<view class="top_right">
					<view class="middle_one">
						<view class="text">预产期：{{DueDate}}</view>
...
<script>
	export default {
		...
		methods: {
			...
			// 获取产检计划
			getPlan() {
				this.$H.post('/gravidawiki/pregnancyTestPlan/findMyPregnancyTestPlan', {}, {
					token: true
				}).then(res => {
					console.log(res);
					if (res.code == 1) {
...
<style lang="scss">
	...
	.top_bj {
		...
		background: url(../../static/img/antenatal1.png) no-repeat center center / 100% 100%;
